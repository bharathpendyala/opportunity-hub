...
from OpportunityHub.api.serializers import UserRegistrationSerializer, UserSerializer, CompanyProfileSerializer, \
    CandidateSerializer, FavoriteJobSerializer
...
class UserProfileView(APIView):
    ...
    def get(self, request):
        ...
        if hasattr(user, 'company'):  # Check if the user has a company profile
            ...
            user_type = 'company'
        elif hasattr(user, 'candidate'):  # Check if the user has a job seeker profile
            profile_serializer = CandidateSerializer(user.candidate)
            user_type = 'candidate'
        else:
...
class CandidateUpdateAPIView(generics.RetrieveUpdateAPIView):
    ...
    def get_object(self):
        # Retrieve the Candidate instance of the current user
