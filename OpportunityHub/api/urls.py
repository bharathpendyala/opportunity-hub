...
from OpportunityHub.api.views import UserRegistrationAPIView, MyTokenObtainPairView, MyTokenRefreshView, UserProfileView, \
    CandidateUpdateAPIView, JobsDetailsAPIView, apply_for_job, job_applicants, AddToFavoritesAPIView, \
    RemoveFromFavoritesAPIView, check_favorite_status
from OpportunityHub.blog.views import BlogPostListCreateAPIView
...
urlpatterns = [
    ...
    path('user/candidate/update/', CandidateUpdateAPIView.as_view(), name='candidate-update'),
