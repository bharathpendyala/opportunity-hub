...
from OpportunityHub.jobs.views import JobCreateView, JobDetails, EditJob, AllJobsView, \
    RemoveFromFavoritesView, add_to_favorites, apply_for_job, DeleteJob, AllJobsViewApi
from OpportunityHub.candidates.views import FavouriteJobs, ApplyJobs
from OpportunityHub.main.views import JobsCategory
