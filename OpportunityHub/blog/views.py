...
from OpportunityHub.accounts.forms import LoginForm
from OpportunityHub.blog.models import BlogPost, Comment
from OpportunityHub.blog.permission import IsAuthor, IsAuthorOrReadOnly
from OpportunityHub.blog.serializers import BlogPostSerializer, CommentSerializer, CommentSerializerCreate
...
class BlogPostListCreateAPIView(generics.ListCreateAPIView):
    ...
    def perform_create(self, serializer):
        serializer.save(author=self.request.user.candidate)
