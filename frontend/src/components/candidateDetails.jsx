...
export default function CandidateDetails() {
    const [candidate, setJobseeker] = useState([]);
    const {id} = useParams();

    useEffect(() => {
        console.log("Start useEffect with ID:", id);
        fetch(`http://127.0.0.1:8000/candidate/candidates/${id}/`)
                                ...
                                <div className="resume-inner">
                                                            ...
                                                            <div className="name-head">
                                                                {candidate.profile_picture && (
                                                                    <a className="mb-2" href="#">
                                                                        <img className="circle-54" src={`https://res.cloudinary.com/drjgddl0y/${candidate.profile_picture}`} alt="" />
                                                                    </a>
                                                                )}

                                                                {/* <h4>{candidate.first_nam}</h4> */}
                                    ...
                                    {% endfor %} */}
                                                ...
                                                <div className="single-section exprerience">
                                                    ...
                                                    {/* {% for experience in candidate.experience.all %}
