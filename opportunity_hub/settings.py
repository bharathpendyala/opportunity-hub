...
INSTALLED_APPS = [
    ...
    'OpportunityHub.notifications',
    'OpportunityHub.accounts',
    'OpportunityHub.main',
    'OpportunityHub.candidates',
    'OpportunityHub.company',
    'OpportunityHub.jobs',
    'OpportunityHub.blog',
    'OpportunityHub.api',
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'OpportunityHub.main.context_processors.subscription_form',
            ],
        },
    },
]
